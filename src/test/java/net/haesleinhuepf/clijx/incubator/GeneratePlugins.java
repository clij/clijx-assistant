...
public class GeneratePlugins {
    ...
    private static String classFromMethodName(CLIJMacroPluginService service, String method) {
        ...
        name = name.replace("clij2.plugins", "clijx.incubator.interactive.generated");
        name = name.replace("clijx.plugins", "clijx.incubator.interactive.generated");
        ...
        name = name.replace("clij2.plugins", "clijx.incubator.interactive.handcrafted");
        name = name.replace("clijx.plugins", "clijx.incubator.interactive.handcrafted");
        name = name.replace("3D", "").replace("Box","");
