...
public class InteractiveRigidTransform3D implements PlugIn {
    ...
    public void run(String arg) {
        GenericDialogPlus gdp = new GenericDialogPlus("Interactive Affine Transform");
        ...
        while(true)
        {
            ...
            gdp = new GenericDialogPlus("Interactive Rigid Transform");
            ...
            gdp.addSlider("Translation X (in pixel)", -100, 100, formerRegistrationTranslationX);
            gdp.addSlider("Translation Y (in pixel)", -100, 100, formerRegistrationTranslationY);
            gdp.addSlider("Translation Z (in pixel)", -100, 100, formerRegistrationTranslationZ);
            gdp.addSlider("Rotation X (in degrees)", -180, 180, formerRegistrationRotationX);
            gdp.addSlider("Rotation Y (in degrees)", -180, 180, formerRegistrationRotationY);
            gdp.addSlider("Rotation Z (in degrees)", -180, 180, formerRegistrationRotationZ);
...
//                            (long) (imp2.getNSlices() * scale2Z)}, clijx.Float);
                    ...
                    transformed = clijx.create(new long[]{
                            (long) (imp2.getWidth()),
                            (long) (imp2.getHeight()),
                            (long) (imp2.getNSlices())}, clijx.Float);
                ...
                if (formerT1 != imp1.getFrame()) {
                    ...
                    input1 = clijx.pushCurrentZStack(imp1);
                    //#scale it initially;
                ...
                if (formerT2 != imp2.getFrame()) {
                    ...
                    input2 = clijx.pushCurrentZStack(imp2);
                    //#scale it initially;
                    //depends on zoom factor and voxel size
                    //AffineTransform3D scaleTransform = new AffineTransform3D();
                    //scaleTransform.scale(1.0 / scale2X, 1.0 / scale2Y, 1.0 / scale2Z);
...
//                }
    ...
    //            formerViewTranslationX = viewTranslationX;
      ...
      //          at.translate(transformed.getWidth() / 2, transformed.getHeight() / 2, transformed.getDepth() / 2);
                ...
                clijx.maximumXProjection(input1, maxXProjection1);
                clijx.maximumYProjection(input1, maxYProjection1);
                clijx.maximumZProjection(input1, maxZProjection1);

                transform =
                        "-center" +
                        " translateX=" + registrationRotationXSlider.getValue() +
                        " translateY=" + registrationRotationYSlider.getValue() +
                        " translateZ=" + registrationRotationZSlider.getValue() +
        ...
        //        at.rotate(1, registrationRotationY);
          //      at.rotate(2, registrationRotationZ);
            //    at.translate(transformed.getWidth() / 2, transformed.getHeight() / 2, transformed.getDepth() / 2);
                ...
                //# Execute operation on GPU
                clijx.affineTransform3D(input2, transformed, transform);
...
//                System.out.println("Scale2Z: " + scale2Z);
                ...
                Recorder.record("Ext.CLIJ2_affineTransform3D(input_place_holder, output_place_holder, \"" + transform + "\")");
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if (e.getSource() == impZ.getWindow().getCanvas()) {
                if (SwingUtilities.isLeftMouseButton(e)) {
                    registrationTranslationXSlider.setValue((int) (parameters.translationX + (deltaX)));
                    registrationTranslationYSlider.setValue((int) (parameters.translationY + (deltaY)));
                } else {
                ...
                if (SwingUtilities.isLeftMouseButton(e)) {
                    registrationTranslationZSlider.setValue((int) (parameters.translationZ + (deltaX)));
                    registrationTranslationYSlider.setValue((int) (parameters.translationY + (deltaY)));
                } else {
                ...
                if (SwingUtilities.isLeftMouseButton(e)) {
                    registrationTranslationXSlider.setValue((int) (parameters.translationX + (deltaX)));
                    registrationTranslationZSlider.setValue((int) (parameters.translationZ + (deltaY)));
                } else {
    ...
    public static void main(String... args){
        ...
        new InteractiveRigidTransform3D().run("");
        System.exit(0);
    }
}
