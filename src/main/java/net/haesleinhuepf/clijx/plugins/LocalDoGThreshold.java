...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_localDoGThreshold")
public class LocalDoGThreshold extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
