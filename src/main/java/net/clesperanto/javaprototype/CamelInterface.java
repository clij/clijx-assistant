...
interface CamelInterface extends CommonAPI{
   static CLIJ getCLIJ() {
   ...
   static void selectDevice(String deviceName) {
     ...
     * 
     */
    static boolean binaryUnion(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean binaryIntersection(ClearCLBuffer operand1, ClearCLBuffer operand2, ClearCLBuffer destination) {
     ...
     */
    static double countNonZeroPixels(ClearCLBuffer source) {
     ...
     */
    static boolean crossCorrelation(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, ClearCLBuffer arg5, double arg6, double arg7, double arg8) {
     ...
     * The second image is shifted by deltaPos in the given dimension. The cross correlation coefficient is calculated for each pixel in a range around the given pixel with given radius in the given dimension. Together with the original images it is recommended to hand over mean filtered images using the same radius.  
     */
    static boolean crossCorrelation(ClearCLImage arg1, ClearCLImage arg2, ClearCLImage arg3, ClearCLImage arg4, ClearCLImage arg5, double arg6, double arg7, double arg8) {
        boolean result = CrossCorrelation.crossCorrelation(getCLIJ2(), arg1, arg2, arg3, arg4, arg5, new Double (arg6).intValue(), new Double (arg7).intValue(), new Double (arg8).intValue());
        return result;
    }
     ...
     */
    static boolean differenceOfGaussian(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     * It is recommended to apply this operation to images of type Float (32 bit) as results might be negative.
     */
    static boolean differenceOfGaussian2D(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     * It is recommended to apply this operation to images of type Float (32 bit) as results might be negative.
     */
    static boolean differenceOfGaussian(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     * It is recommended to apply this operation to images of type Float (32 bit) as results might be negative.
     */
    static boolean differenceOfGaussian3D(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean localExtremaBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     * local id
     */
    static boolean localID(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean maskLabel(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4) {
     ...
     */
    static double meanClosestSpotDistance(ClearCLBuffer arg1, ClearCLBuffer arg2) {
     ...
     * Takes two binary images A and B with marked spots and determines for each spot in image A the closest spot in image B. Afterwards, it saves the average shortest distances from image A to image B as 'mean_closest_spot_distance_A_B' and from image B to image A as 'mean_closest_spot_distance_B_A' to the results table. The distance between B and A is only determined if the `bidirectional` checkbox is checked.
     */
    static double[] meanClosestSpotDistance(ClearCLBuffer arg1, ClearCLBuffer arg2, boolean arg3) {
     ...
     */
    static double meanSquaredError(ClearCLBuffer source1, ClearCLBuffer source2) {
     ...
     */
    static boolean medianZProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean nonzeroMinimumDiamond(ClearCLImageInterface input, ClearCLImageInterface destination) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMinimumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static ClearCLKernel nonzeroMinimumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
     ...
     */
    static double jaccardIndex(ClearCLBuffer source1, ClearCLBuffer source2) {
     ...
     * <pre>s = f(j) = 2 j / (j + 1)</pre>
     */
    static double sorensenDiceCoefficient(ClearCLBuffer source1, ClearCLBuffer source2) {
     ...
     */
    static boolean standardDeviationZProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * Stack to tiles.
     */
    static boolean stackToTiles(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static boolean subtractBackground(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * Deprecated: Use topHat() or differenceOfGaussian() instead.
     */
    static boolean subtractBackground2D(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * Deprecated: Use topHat() or differenceOfGaussian() instead.
     */
    static boolean subtractBackground(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * Deprecated: Use topHat() or differenceOfGaussian() instead.
     */
    static boolean subtractBackground3D(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * 
     */
    static boolean topHatBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     * 
     */
    static boolean topHatSphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean generateDistanceMatrix(ClearCLBuffer coordinate_list1, ClearCLBuffer coordinate_list2, ClearCLBuffer distance_matrix_destination) {
     ...
     */
    static boolean shortestDistances(ClearCLBuffer distance_matrix, ClearCLBuffer destination_minimum_distances) {
     ...
     */
    static boolean spotsToPointList(ClearCLBuffer input_spots, ClearCLBuffer destination_pointlist) {
     ...
     * 
     */
    static boolean transposeXY(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean transposeXZ(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean transposeYZ(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean particleImageVelocimetry2D(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, double arg5) {
     ...
     */
    static boolean particleImageVelocimetry(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, ClearCLBuffer arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean particleImageVelocimetryTimelapse(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4, double arg5, double arg6, double arg7, boolean arg8) {
     ...
     */
    static boolean deformableRegistration2D(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4, double arg5) {
     ...
     */
    static boolean translationRegistration(ClearCLBuffer arg1, ClearCLBuffer arg2, double[] arg3) {
     ...
     * Measures center of mass of thresholded objects in the two input images and translates the second image so that it better fits to the first image.
     */
    static boolean translationRegistration(ClearCLBuffer input1, ClearCLBuffer input2, ClearCLBuffer destination) {
     ...
     */
    static boolean translationTimelapseRegistration(ClearCLBuffer input, ClearCLBuffer output) {
     ...
     */
    static boolean setWhereXequalsY(ClearCLImageInterface arg1, double arg2) {
     ...
     */
    static boolean laplaceSphere(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean writeValuesToPositions(ClearCLBuffer positionsAndValues, ClearCLBuffer destination) {
     ...
     */
    static boolean multiplyMatrix(ClearCLBuffer matrix1, ClearCLBuffer matrix2, ClearCLBuffer matrix_destination) {
     ...
     */
    static boolean matrixEqual(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean powerImages(ClearCLBuffer input, ClearCLBuffer exponent, ClearCLBuffer destination) {
     ...
     */
    static boolean greaterOrEqual(ClearCLImageInterface source1, ClearCLImageInterface source2, ClearCLImageInterface destination) {
     ...
     * f(a, b) = 1 if a <= b; 0 otherwise. 
     */
    static boolean smallerOrEqual(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean notEqual(ClearCLImageInterface source1, ClearCLImageInterface source2, ClearCLBuffer destination) {
     ...
     */
    static ClearCLBuffer readImageFromDisc(String arg1) {
     ...
     */
    static boolean readRawImageFromDisc(ClearCLBuffer arg1, String arg2) {
     ...
     * Reads a raw file from disc and pushes it immediately to the GPU.
     */
    static ClearCLBuffer readRawImageFromDisc(String arg1, double arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static ClearCLBuffer preloadFromDisc(ClearCLBuffer destination, String filename, String nextFilename, String loaderId) {
     ...
     * 
     */
    static boolean equalConstant(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * f(a, b) = 1 if a >= b; 0 otherwise. 
     */
    static boolean greaterOrEqualConstant(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * f(a, b) = 1 if a > b; 0 otherwise. 
     */
    static boolean greaterConstant(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * f(a, b) = 1 if a < b; 0 otherwise. 
     */
    static boolean smallerConstant(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * f(a, b) = 1 if a <= b; 0 otherwise. 
     */
    static boolean smallerOrEqualConstant(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * 
     */
    static boolean notEqualConstant(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean drawBox(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5) {
     ...
     * All pixels other than in the box are untouched. Consider using `set(buffer, 0);` in advance.
     */
    static boolean drawBox(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7) {
     ...
     * All pixels other than in the box are untouched. Consider using `set(buffer, 0);` in advance.
     */
    static boolean drawBox(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean drawLine(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     * All pixels other than on the line are untouched. Consider using `set(buffer, 0);` in advance.
     */
    static boolean drawLine(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9) {
     ...
     */
    static boolean drawSphere(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5) {
     ...
     *  All pixels other than in the sphere are untouched. Consider using `set(buffer, 0);` in advance.
     */
    static boolean drawSphere(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     *  All pixels other than in the sphere are untouched. Consider using `set(buffer, 0);` in advance.
     */
    static boolean drawSphere(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7) {
     ...
     *  All pixels other than in the sphere are untouched. Consider using `set(buffer, 0);` in advance.
     */
    static boolean drawSphere(ClearCLImageInterface arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean replaceIntensity(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static double[] boundingBox(ClearCLBuffer source) {
     ...
     */
    static double minimumOfMaskedPixels(ClearCLBuffer source, ClearCLBuffer mask) {
     ...
     * 
     */
    static double maximumOfMaskedPixels(ClearCLBuffer source, ClearCLBuffer mask) {
     ...
     */
    static double meanOfMaskedPixels(ClearCLBuffer source, ClearCLBuffer mask) {
     ...
     */
    static boolean labelToMask(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean nClosestPoints(ClearCLBuffer arg1, ClearCLBuffer arg2) {
     ...
     */
    static boolean gaussJordan(ClearCLBuffer A_matrix, ClearCLBuffer B_result_vector, ClearCLBuffer solution_destination) {
     ...
     */
    static double[] statisticsOfLabelledPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * This method is executed on the CPU and not on the GPU/OpenCL device.
     */
    static double[][] statisticsOfLabelledPixels(ClearCLBuffer input, ClearCLBuffer labelmap) {
     ...
     * This method is executed on the CPU and not on the GPU/OpenCL device.
     */
    static double[][] statisticsOfLabelledPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     * 
     */
    static double[][] statisticsOfLabelledPixels_single_threaded(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     * This method is executed on the CPU and not on the GPU/OpenCL device.
     */
    static ResultsTable statisticsOfLabelledPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, ResultsTable arg3) {
     ...
     */
    static double varianceOfAllPixels(ClearCLBuffer source) {
     ...
     * Results table in the column 'Variance'.
     */
    static double varianceOfAllPixels(ClearCLImageInterface arg1, double arg2) {
     ...
     */
    static double standardDeviationOfAllPixels(ClearCLImageInterface source) {
     ...
     * Results table in the column 'Standard_deviation'.
     */
    static double standardDeviationOfAllPixels(ClearCLImageInterface arg1, double arg2) {
     ...
     */
    static double varianceOfMaskedPixels(ClearCLBuffer source, ClearCLBuffer mask) {
     ...
     * The result is put in the results table as new column named 'Masked_variance'.
     */
    static double varianceOfMaskedPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static double standardDeviationOfMaskedPixels(ClearCLBuffer source, ClearCLBuffer mask) {
     ...
     * Results table in the column 'Masked_standard_deviation'.
     */
    static double standardDeviationOfMaskedPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean excludeLabelsOnEdges(ClearCLBuffer label_map_input, ClearCLBuffer label_map_destination) {
     ...
     * 
     */
    static boolean binarySubtract(ClearCLImageInterface minuend, ClearCLImageInterface subtrahend, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean binaryEdgeDetection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean distanceMap(ClearCLBuffer source, ClearCLBuffer destination) {
     ...
     */
    static Roi pullAsROI(ClearCLBuffer binary_input) {
     ...
     */
    static boolean pullLabelsToROIManager(ClearCLBuffer labelmap_input) {
     ...
     * Pulls all labels in a label map as ROIs to the ROI manager.
     */
    static boolean pullLabelsToROIManager(ClearCLBuffer arg1, RoiManager arg2) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMaximumDiamond(ClearCLImageInterface input, ClearCLImageInterface destination) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMaximumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static ClearCLKernel nonzeroMaximumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
     ...
     */
    static boolean onlyzeroOverwriteMaximumDiamond(ClearCLImageInterface input, ClearCLImageInterface destination) {
     ...
     * Apply a local maximum filter to an image which only overwrites pixels with value 0.
     */
    static boolean onlyzeroOverwriteMaximumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
     ...
     * Apply a local maximum filter to an image which only overwrites pixels with value 0.
     */
    static ClearCLKernel onlyzeroOverwriteMaximumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
     ...
     * Apply a local maximum filter to an image which only overwrites pixels with value 0.
     */
    static boolean onlyzeroOverwriteMaximumBox(ClearCLImageInterface input, ClearCLImageInterface destination) {
     ...
     * Apply a local maximum filter to an image which only overwrites pixels with value 0.
     */
    static boolean onlyzeroOverwriteMaximumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
     ...
     * Apply a local maximum filter to an image which only overwrites pixels with value 0.
     */
    static ClearCLKernel onlyzeroOverwriteMaximumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
     ...
     * 
     */
    static boolean generateTouchMatrix(ClearCLBuffer label_map, ClearCLBuffer touch_matrix_destination) {
     ...
     */
    static boolean detectLabelEdges(ClearCLImageInterface label_map, ClearCLBuffer edge_image_destination) {
     ...
     */
    static boolean stopWatch(String text) {
     ...
     */
    static boolean countTouchingNeighbors(ClearCLBuffer touch_matrix, ClearCLBuffer touching_neighbors_count_destination) {
     ...
     * 
     */
    static boolean replaceIntensities(ClearCLImageInterface input, ClearCLImageInterface new_values_vector, ClearCLImageInterface destination) {
     ...
     */
    static boolean drawTwoValueLine(ClearCLBuffer arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10) {
     ...
     */
    static boolean averageDistanceOfNClosestPoints(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean saveAsTIF(ClearCLBuffer input, String filename) {
     ...
     * 
     */
    static boolean touchMatrixToMesh(ClearCLBuffer pointlist, ClearCLBuffer touch_matrix, ClearCLBuffer mesh_destination) {
     ...
     */
    static boolean equalizeMeanIntensitiesOfSlices(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean resliceRadial(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * X/Y-plane of a given input image stack. Furthermore, radius of the resulting projection must be given and scaling factors in X and Y in case pixels are not isotropic.This operation is similar to ImageJs 'Radial Reslice' method but offers less flexibility.
     */
    static boolean resliceRadial(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     * X/Y-plane of a given input image stack. Furthermore, radius of the resulting projection must be given and scaling factors in X and Y in case pixels are not isotropic.This operation is similar to ImageJs 'Radial Reslice' method but offers less flexibility.
     */
    static boolean resliceRadial(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean showRGB(ClearCLBuffer red, ClearCLBuffer green, ClearCLBuffer blue, String title) {
     ...
     */
    static ImagePlus showGrey(ClearCLBuffer input, String title) {
     ...
     */
    static boolean laplaceBox(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean bottomHatBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     * 
     */
    static boolean bottomHatSphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean closingBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean closingDiamond(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean openingBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * Apply a binary opening to the input image by calling n erosions and n dilations subsequenntly.
     */
    static boolean openingDiamond(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean maximumXProjection(ClearCLImageInterface source, ClearCLImageInterface destination_max) {
     ...
     * Determines the maximum intensity projection of an image along X.
     */
    static boolean maximumYProjection(ClearCLImageInterface source, ClearCLImageInterface destination_max) {
     ...
     */
    static boolean maximumZProjectionBounded(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static boolean minimumZProjectionBounded(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static boolean meanZProjectionBounded(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMaximumBox(ClearCLImageInterface input, ClearCLImageInterface destination) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMaximumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static ClearCLKernel nonzeroMaximumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMinimumBox(ClearCLImageInterface input, ClearCLImageInterface destination) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static boolean nonzeroMinimumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3) {
     ...
     * Thus, the result image should be initialized by copying the original image in advance.
     */
    static ClearCLKernel nonzeroMinimumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLKernel arg4) {
     ...
     */
    static boolean minimumZProjectionThresholdedBounded(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static double meanOfPixelsAboveThreshold(ClearCLBuffer arg1, double arg2) {
     ...
     */
    static boolean organiseWindows(double arg1, double arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     */
    static boolean distanceMatrixToMesh(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4) {
     ...
     */
    static boolean pointIndexListToMesh(ClearCLBuffer pointlist, ClearCLBuffer indexList, ClearCLBuffer mesh_destination) {
     ...
     */
    static boolean minimumOctagon(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean maximumOctagon(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean topHatOctagon(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * 
     */
    static boolean addImages(ClearCLImageInterface summand1, ClearCLImageInterface summand2, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean addImagesWeighted(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, double arg4, double arg5) {
     ...
     * <pre>f(x, y) = x - y</pre>
     */
    static boolean subtractImages(ClearCLImageInterface subtrahend, ClearCLImageInterface minuend, ClearCLImageInterface destination) {
     ...
     */
    static boolean showGlasbeyOnGrey(ClearCLBuffer red, ClearCLBuffer labelling, String title) {
     ...
     */
    static boolean affineTransform2D(ClearCLBuffer arg1, ClearCLImageInterface arg2, float[] arg3) {
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform2D(ClearCLBuffer source, ClearCLImageInterface destination, String transform) {
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform2D(ClearCLBuffer arg1, ClearCLImageInterface arg2, net.imglib2.realtransform.AffineTransform2D arg3) {
        boolean result = AffineTransform2D.affineTransform2D(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform2D(ClearCLImage arg1, ClearCLImageInterface arg2, float[] arg3) {
        boolean result = AffineTransform2D.affineTransform2D(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform2D(ClearCLImage arg1, ClearCLImageInterface arg2, net.imglib2.realtransform.AffineTransform2D arg3) {
        boolean result = AffineTransform2D.affineTransform2D(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform3D(ClearCLBuffer arg1, ClearCLImageInterface arg2, float[] arg3) {
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform3D(ClearCLBuffer source, ClearCLImageInterface destination, String transform) {
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform3D(ClearCLBuffer arg1, ClearCLImageInterface arg2, net.imglib2.realtransform.AffineTransform3D arg3) {
        boolean result = AffineTransform3D.affineTransform3D(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform3D(ClearCLImage arg1, ClearCLImageInterface arg2, float[] arg3) {
        boolean result = AffineTransform3D.affineTransform3D(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     * transform = "-center scale=2 rotate=45 center";
     */
    static boolean affineTransform3D(ClearCLImage arg1, ClearCLImageInterface arg2, net.imglib2.realtransform.AffineTransform3D arg3) {
        boolean result = AffineTransform3D.affineTransform3D(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     */
    static boolean applyVectorField(ClearCLImageInterface source, ClearCLImageInterface vectorX, ClearCLImageInterface vectorY, ClearCLImageInterface destination) {
     ...
     *  It is recommended to use 32-bit images for input, output and vector images. 
     */
    static boolean applyVectorField2D(ClearCLImageInterface source, ClearCLImageInterface vectorX, ClearCLImageInterface vectorY, ClearCLImageInterface destination) {
     ...
     *  It is recommended to use 32-bit images for input, output and vector images. 
     */
    static boolean applyVectorField(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, ClearCLImageInterface arg4, ClearCLImageInterface arg5) {
     ...
     */
    static boolean applyVectorField3D(ClearCLImageInterface source, ClearCLImageInterface vectorX, ClearCLImageInterface vectorY, ClearCLImageInterface vectorZ, ClearCLImageInterface destination) {
     ...
     */
    static boolean argMaximumZProjection(ClearCLImageInterface source, ClearCLImageInterface destination_max, ClearCLImageInterface destination_arg_max) {
     ...
     */
    static boolean automaticThreshold(ClearCLBuffer input, ClearCLBuffer destination, String method) {
     ...
     * [Default, Huang, Intermodes, IsoData, IJ_IsoData, Li, MaxEntropy, Mean, MinError, Minimum, Moments, Otsu, Percentile, RenyiEntropy, Shanbhag, Triangle, Yen]
     */
    static boolean automaticThreshold(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3, double arg4, double arg5, double arg6) {
     ...
     * 
     */
    static boolean binaryOr(ClearCLImageInterface operand1, ClearCLImageInterface operand2, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean binaryAnd(ClearCLImageInterface operand1, ClearCLImageInterface operand2, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean binaryXOr(ClearCLImageInterface operand1, ClearCLImageInterface operand2, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean binaryNot(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean erodeSphere(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean erodeBox(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean erodeSphereSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * This filter is applied slice by slice in 2D.
     */
    static boolean erodeBoxSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * The pixels in the input image with pixel value not equal to 0 will be interpreted as 1.
     */
    static boolean dilateSphere(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * difference is that the output image contains values 0 and 1 instead of 0 and 255.
     */
    static boolean dilateBox(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * This filter is applied slice by slice in 2D.
     */
    static boolean dilateSphereSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * This filter is applied slice by slice in 2D.
     */
    static boolean dilateBoxSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean copySlice(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     */
    static boolean rotateCounterClockwise(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * such as interpolation.
     */
    static boolean rotateClockwise(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * <pre>f(x,m) = (x if (m != 0); (0 otherwise))</pre>
     */
    static boolean maskStackWithPlane(ClearCLImageInterface source, ClearCLImageInterface mask, ClearCLImageInterface destination) {
     ...
     */
    static boolean maximumZProjection(ClearCLImageInterface source, ClearCLImageInterface destination_max) {
     ...
     */
    static boolean meanZProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean minimumZProjection(ClearCLImageInterface source, ClearCLImageInterface destination_min) {
     ...
     * <pre>f(x, y) = x / y</pre>
     */
    static boolean divideImages(ClearCLImageInterface divident, ClearCLImageInterface divisor, ClearCLImageInterface destination) {
     ...
     */
    static boolean maximumImages(ClearCLImageInterface source1, ClearCLImageInterface source2, ClearCLImageInterface destination) {
     ...
     */
    static boolean maximumImageAndScalar(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     */
    static boolean minimumImages(ClearCLImageInterface source1, ClearCLImageInterface source2, ClearCLImageInterface destination) {
     ...
     */
    static boolean minimumImageAndScalar(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * 
     */
    static boolean multiplyImageAndScalar(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * <pre>f(x, y) = x * y</pre>
     */
    static boolean multiplyStackWithPlane(ClearCLImageInterface sourceStack, ClearCLImageInterface sourcePlane, ClearCLImageInterface destination) {
     ...
     */
    static boolean countNonZeroPixels2DSphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     */
    static boolean countNonZeroPixelsSliceBySliceSphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     * Put the number in the result image.
     */
    static boolean countNonZeroVoxels3DSphere(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean sumZProjection(ClearCLImageInterface source, ClearCLImageInterface destination_sum) {
     ...
     * 
     */
    static double sumOfAllPixels(ClearCLImageInterface source) {
     ...
     */
    static double[] centerOfMass(ClearCLBuffer source) {
     ...
     */
    static boolean downsampleSliceBySliceHalfMedian(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean localThreshold(ClearCLImageInterface source, ClearCLImageInterface localThreshold, ClearCLImageInterface destination) {
     ...
     */
    static boolean gradientX(ClearCLBuffer source, ClearCLBuffer destination) {
     ...
     */
    static boolean gradientY(ClearCLBuffer source, ClearCLBuffer destination) {
     ...
     */
    static boolean gradientZ(ClearCLBuffer source, ClearCLBuffer destination) {
     ...
     */
    static boolean multiplyImageAndCoordinate(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     */
    static boolean mean2DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean mean2DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static boolean mean3DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean meanBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width, half-height and half-depth (radius).
     */
    static boolean mean3DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * This filter is applied slice by slice in 2D.
     */
    static boolean meanSliceBySliceSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * 
     */
    static double meanOfAllPixels(ClearCLImageInterface source) {
     ...
     */
    static boolean median2DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static boolean median2DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     */
    static boolean median3DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean median3DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * For technical reasons, the area of the rectangle must have less than 1000 pixels.
     */
    static boolean median3DSliceBySliceBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * For technical reasons, the area of the ellipse must have less than 1000 pixels.
     */
    static boolean median3DSliceBySliceSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean maximum2DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width, half-height and half-depth (radius).
     */
    static boolean maximum3DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean maximum2DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean maximumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width, half-height and half-depth (radius).
     */
    static boolean maximum3DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean maximumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * This filter is applied slice by slice in 2D.
     */
    static boolean maximum3DSliceBySliceSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean minimum2DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width, half-height and half-depth (radius).
     */
    static boolean minimum3DSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean minimum2DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean minimumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * its half-width, half-height and half-depth (radius).
     */
    static boolean minimum3DBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width and half-height (radius).
     */
    static boolean minimumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * This filter is applied slice by slice in 2D.
     */
    static boolean minimum3DSliceBySliceSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * 
     */
    static boolean multiplyImages(ClearCLImageInterface factor1, ClearCLImageInterface factor2, ClearCLImageInterface destination) {
     ...
     */
    static boolean gaussianBlur(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * The implementation is done separable. In case a sigma equals zero, the direction is not blurred.
     */
    static boolean gaussianBlur2D(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * The implementation is done separable. In case a sigma equals zero, the direction is not blurred.
     */
    static boolean gaussianBlur(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * The implementation is done separable. In case a sigma equals zero, the direction is not blurred.
     */
    static boolean gaussianBlur3D(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean resliceBottom(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * offers less flexibility such as interpolation.
     */
    static boolean resliceTop(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean resliceLeft(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     *  but offers less flexibility such as interpolation.
     */
    static boolean resliceRight(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean addImageAndScalar(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     */
    static boolean detectMinimaBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean detectMaximaBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean detectMaximaSliceBySliceBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     */
    static boolean detectMinimaSliceBySliceBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     * 
     */
    static double maximumOfAllPixels(ClearCLImageInterface source) {
     ...
     * 
     */
    static double minimumOfAllPixels(ClearCLImageInterface source) {
     ...
     * Odd iterations are done with box neighborhood, even iterations with a diamond. Thus, with n > 2, the filter shape is an octagon. The given number of iterations - 2 makes the filter result very similar to minimum sphere.
     */
    static boolean topHatOctagonSliceBySlice(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean setColumn(ClearCLImageInterface arg1, double arg2, double arg3) {
     ...
     */
    static boolean setRow(ClearCLImageInterface arg1, double arg2, double arg3) {
     ...
     * Determines the sum intensity projection of an image along Z.
     */
    static boolean sumYProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     *  for every object.
     */
    static boolean averageDistanceOfTouchingNeighbors(ClearCLBuffer distance_matrix, ClearCLBuffer touch_matrix, ClearCLBuffer average_distancelist_destination) {
     ...
     * pixels (with d = dimensionality of the original image) with the coordinates of the maxima/minima.
     */
    static boolean labelledSpotsToPointList(ClearCLBuffer input_labelled_spots, ClearCLBuffer destination_pointlist) {
     ...
     */
    static boolean labelSpots(ClearCLBuffer input_spots, ClearCLBuffer labelled_spots_destination) {
     ...
     */
    static boolean minimumDistanceOfTouchingNeighbors(ClearCLBuffer distance_matrix, ClearCLBuffer touch_matrix, ClearCLBuffer minimum_distancelist_destination) {
     ...
     */
    static boolean writeVTKLineListToDisc(ClearCLBuffer pointlist, ClearCLBuffer touch_matrix, String filename) {
     ...
     */
    static boolean writeXYZPointListToDisc(ClearCLBuffer pointlist, String filename) {
     ...
     * If you want to initialize an identity transfrom matrix, set all pixels to 0 first.
     */
    static boolean setWhereXgreaterThanY(ClearCLImageInterface arg1, double arg2) {
     ...
     * If you want to initialize an identity transfrom matrix, set all pixels to 0 first.
     */
    static boolean setWhereXsmallerThanY(ClearCLImageInterface arg1, double arg2) {
     ...
     */
    static boolean setNonZeroPixelsToPixelIndex(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean closeIndexGapsInLabelMap(ClearCLBuffer labeling_input, ClearCLImageInterface labeling_destination) {
     ...
     */
    static boolean centroidsOfLabels(ClearCLBuffer source, ClearCLBuffer pointlist_destination) {
     ...
     */
    static boolean setRampX(ClearCLImageInterface source) {
     ...
     */
    static boolean setRampY(ClearCLImageInterface source) {
     ...
     */
    static boolean setRampZ(ClearCLImageInterface source) {
     ...
     * <pre>f(x, s) = s - x</pre>
     */
    static boolean subtractImageFromScalar(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdDefault(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdOtsu(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdHuang(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdIntermodes(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdIsoData(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdIJ_IsoData(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdLi(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdMaxEntropy(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdMean(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdMinError(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdMinimum(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdMoments(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdPercentile(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdRenyiEntropy(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdShanbhag(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdTriangle(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method.
     */
    static boolean thresholdYen(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean excludeLabelsSubSurface(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4, double arg5, double arg6) {
     ...
     * If yes, this label is eliminated from the label map.
     */
    static boolean excludeLabelsOnSurface(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4, double arg5, double arg6) {
     ...
     */
    static boolean setPlane(ClearCLImageInterface arg1, double arg2, double arg3) {
     ...
     */
    static boolean tenengradFusion(ClearCLBuffer arg1, float[] arg2, float arg3, ClearCLBuffer[] arg4) {
     ...
     * Fuses #n# image stacks using Tenengrads algorithm.
     */
    static boolean tenengradFusion(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7) {
     ...
     */
    static boolean imageToStack(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * Determines the sum intensity projection of an image along Z.
     */
    static boolean sumXProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean sumImageSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     * Sums all pixels slice by slice and returns them in an array.
     */
    static double[] sumImageSliceBySlice(ClearCLImageInterface arg1) {
     ...
     * <pre>f(x, s) = x * s</pre>
     */
    static boolean multiplyImageStackWithScalars(ClearCLImageInterface arg1, ClearCLImageInterface arg2, float[] arg3) {
     ...
     * <pre>f(x, s) = x * s</pre>
     */
    static boolean multiplyImageStackWithScalars(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLBuffer arg3) {
        boolean result = MultiplyImageStackWithScalars.multiplyImageStackWithScalars(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     */
    static boolean voronoiOctagon(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean setImageBorders(ClearCLImageInterface arg1, double arg2) {
     ...
     */
    static boolean floodFillDiamond(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     */
    static boolean binaryFillHoles(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean connectedComponentsLabelingDiamond(ClearCLImageInterface binary_input, ClearCLImageInterface labeling_destination) {
     ...
     * Performs connected components analysis inspecting the diamond neighborhood of every pixel to a binary image and generates a label map.
     */
    static boolean connectedComponentsLabelingDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, boolean arg3) {
     ...
     */
    static boolean connectedComponentsLabelingBox(ClearCLImageInterface binary_input, ClearCLImageInterface labeling_destination) {
     ...
     * Performs connected components analysis inspecting the box neighborhood of every pixel to a binary image and generates a label map.
     */
    static boolean connectedComponentsLabelingBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, boolean arg3) {
     ...
     */
    static boolean setRandom(ClearCLBuffer arg1, double arg2, double arg3) {
     ...
     * Recommendation: For the seed, use getTime().
     */
    static boolean setRandom(ClearCLBuffer arg1, double arg2, double arg3, double arg4) {
     ...
     */
    static boolean entropyBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     * Determines the local entropy in a box with a given radius around every pixel.
     */
    static boolean entropyBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7) {
     ...
     */
    static ClearCLBuffer pushTile(ImagePlus arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10) {
     ...
     * Push a tile in an image specified by its name, position and size to GPU memory in order to process it there later.
     */
    static ClearCLBuffer pushTile(ClearCLBuffer arg1, double arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10) {
        ClearCLBuffer result = PushTile.pushTile(getCLIJ2(), arg1, new Double (arg2).intValue(), new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue(), new Double (arg6).intValue(), new Double (arg7).intValue(), new Double (arg8).intValue(), new Double (arg9).intValue(), new Double (arg10).intValue());
        return result;
    }
     ...
     * Push a tile in an image specified by its name, position and size to GPU memory in order to process it there later.
     */
    static void pushTile(ImagePlus arg1, String arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10, double arg11) {
     ...
     */
    static void pullTile(ImagePlus arg1, String arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10, double arg11) {
     ...
     * Pushes a tile in an image specified by its name, position and size from GPU memory.
     */
    static void pullTile(ImagePlus arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10, double arg11) {
        PullTile.pullTile(getCLIJ2(), arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue(), new Double (arg6).intValue(), new Double (arg7).intValue(), new Double (arg8).intValue(), new Double (arg9).intValue(), new Double (arg10).intValue(), new Double (arg11).intValue());
    }
     ...
     * Pushes a tile in an image specified by its name, position and size from GPU memory.
     */
    static void pullTile(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8, double arg9, double arg10, double arg11) {
        PullTile.pullTile(getCLIJ2(), arg1, arg2, new Double (arg3).intValue(), new Double (arg4).intValue(), new Double (arg5).intValue(), new Double (arg6).intValue(), new Double (arg7).intValue(), new Double (arg8).intValue(), new Double (arg9).intValue(), new Double (arg10).intValue(), new Double (arg11).intValue());
    }
     ...
     */
    static boolean concatenateStacks(ClearCLImageInterface stack1, ClearCLImageInterface stack2, ClearCLImageInterface destination) {
     ...
     * [Default, Huang, Intermodes, IsoData, IJ_IsoData, Li, MaxEntropy, Mean, MinError, Minimum, Moments, Otsu, Percentile, RenyiEntropy, Shanbhag, Triangle, Yen]
     */
    static double getAutomaticThreshold(ClearCLBuffer arg1, String arg2) {
     ...
     * [Default, Huang, Intermodes, IsoData, IJ_IsoData, Li, MaxEntropy, Mean, MinError, Minimum, Moments, Otsu, Percentile, RenyiEntropy, Shanbhag, Triangle, Yen]
     */
    static double getAutomaticThreshold(ClearCLBuffer arg1, String arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static long[] getDimensions(ClearCLBuffer arg1) {
     ...
     * 
     */
    static boolean customOperation(String arg1, String arg2, HashMap arg3) {
     ...
     * 
     */
    static boolean applyAutoContextWekaModelWithOptions(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3, String arg4, double arg5) {
     ...
     * 
     */
    static boolean trainAutoContextWekaModelWithOptions(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3, String arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean applyWekaModel(ClearCLBuffer arg1, ClearCLBuffer arg2, CLIJxWeka2 arg3) {
     ...
     * It takes a 3D feature stack (e.g. first plane original image, second plane blurred, third plane edge image)and applies a pre-trained a Weka model. Take care that the feature stack has been generated in the sameway as for training the model!
     */
    static CLIJxWeka2 applyWekaModel(ClearCLBuffer featureStack3D, ClearCLBuffer prediction2D_destination, String loadModelFilename) {
     ...
     */
    static CLIJxWeka2 applyWekaToTable(ResultsTable arg1, String arg2, String arg3) {
     ...
     * It takes a Results Table, sorts its columns by name alphabetically and uses it as extracted features (rows correspond to feature vectors) and applies a pre-trained a Weka model. Take care that the table has been generated in the sameway as for training the model!
     */
    static CLIJxWeka2 applyWekaToTable(ResultsTable arg1, String arg2, CLIJxWeka2 arg3) {
        CLIJxWeka2 result = ApplyWekaToTable.applyWekaToTable(getCLIJ2(), arg1, arg2, arg3);
        return result;
    }
     ...
     */
    static boolean generateFeatureStack(ClearCLBuffer input, ClearCLBuffer feature_stack_destination, String feature_definitions) {
     ...
     * Example: "original gaussianBlur=1 gaussianBlur=5 laplacianOfGaussian=1 laplacianOfGaussian=7 entropy=3"
     */
    static ClearCLBuffer generateFeatureStack(ClearCLBuffer arg1, String arg2) {
     ...
     */
    static CLIJxWeka2 trainWekaModel(ClearCLBuffer featureStack3D, ClearCLBuffer groundTruth2D, String saveModelFilename) {
     ...
     * * maxDepth = 0
     */
    static CLIJxWeka2 trainWekaFromTable(ResultsTable arg1, String arg2, double arg3, double arg4, double arg5) {
     ...
     * * maxDepth = 0
     */
    static CLIJxWeka2 trainWekaFromTable(ResultsTable arg1, String arg2, String arg3, double arg4, double arg5, double arg6) {
     ...
     * * maxDepth = 0
     */
    static CLIJxWeka2 trainWekaModelWithOptions(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3, double arg4, double arg5, double arg6) {
     ...
     */
    static boolean startContinuousWebcamAcquisition(double arg1, double arg2, double arg3) {
     ...
     */
    static boolean stopContinuousWebcamAcquisition(double arg1) {
     ...
     */
    static boolean captureWebcamImage(ClearCLBuffer arg1, double arg2, double arg3, double arg4) {
     ...
     */
    static boolean convertRGBStackToGraySlice(ClearCLBuffer stack_source, ClearCLBuffer slice_destination) {
     ...
     */
    static boolean pullLabelsToROIList(ClearCLBuffer arg1, List arg2) {
     ...
     * window. From ImageJ macro conside using pullLabelsToROIManager.
     */
    static ArrayList pullLabelsToROIList(ClearCLBuffer labelmap_input) {
     ...
     * 
     */
    static boolean meanOfTouchingNeighbors(ClearCLBuffer values, ClearCLBuffer touch_matrix, ClearCLBuffer mean_values_destination) {
     ...
     * 
     */
    static boolean minimumOfTouchingNeighbors(ClearCLBuffer values, ClearCLBuffer touch_matrix, ClearCLBuffer minimum_values_destination) {
     ...
     * 
     */
    static boolean maximumOfTouchingNeighbors(ClearCLBuffer values, ClearCLBuffer touch_matrix, ClearCLBuffer maximum_values_destination) {
     ...
     */
    static boolean resultsTableColumnToImage(ClearCLBuffer arg1, ResultsTable arg2, String arg3) {
     ...
     * This method is executed on the CPU and not on the GPU/OpenCL device.
     */
    static double[][] statisticsOfBackgroundAndLabelledPixels(ClearCLBuffer input, ClearCLBuffer labelmap) {
     ...
     * This method is executed on the CPU and not on the GPU/OpenCL device.
     */
    static ResultsTable statisticsOfBackgroundAndLabelledPixels(ClearCLBuffer arg1, ClearCLBuffer arg2, ResultsTable arg3) {
     ...
     */
    static double getSumOfAllPixels(ClearCLImageInterface arg1) {
     ...
     * <pre>s = f(j) = 2 j / (j + 1)</pre>
     */
    static double getSorensenDiceCoefficient(ClearCLBuffer arg1, ClearCLBuffer arg2) {
     ...
     */
    static double getMinimumOfAllPixels(ClearCLImageInterface arg1) {
     ...
     */
    static double getMaximumOfAllPixels(ClearCLImageInterface arg1) {
     ...
     */
    static double getMeanOfAllPixels(ClearCLImageInterface arg1) {
     ...
     * <pre>s = f(j) = 2 j / (j + 1)</pre>
     */
    static double getJaccardIndex(ClearCLBuffer arg1, ClearCLBuffer arg2) {
     ...
     */
    static double[] getCenterOfMass(ClearCLBuffer arg1) {
     ...
     */
    static double[] getBoundingBox(ClearCLBuffer arg1) {
     ...
     */
    static boolean pushArray(ClearCLBuffer arg1, Object arg2) {
     ...
     * Converts an array to an image.
     */
    static ClearCLBuffer pushArray(float[] arg1, double arg2, double arg3, double arg4) {
     ...
     */
    static String pullString(ClearCLImageInterface arg1) {
     ...
     * 
     */
    static boolean pushString(ClearCLBuffer arg1, String arg2) {
     ...
     * 
     */
    static ClearCLBuffer pushString(String arg1) {
     ...
     * 
     */
    static boolean medianOfTouchingNeighbors(ClearCLBuffer values, ClearCLBuffer touch_matrix, ClearCLBuffer mean_values_destination) {
     ...
     * The values are stored in x dimension.
     */
    static boolean pushResultsTableColumn(ClearCLBuffer arg1, ResultsTable arg2, String arg3) {
     ...
     */
    static boolean pushResultsTable(ClearCLBuffer arg1, ResultsTable arg2) {
     ...
     */
    static ResultsTable pullToResultsTable(ClearCLBuffer arg1, ResultsTable arg2) {
     ...
     * Converts an image into a table.
     */
    static ResultsTable pullToResultsTable(ClearCLImage arg1, ResultsTable arg2) {
        ResultsTable result = PullToResultsTable.pullToResultsTable(getCLIJ2(), arg1, arg2);
        return result;
    }
     ...
     * The pixels where  the regions touched are afterwards returned as binary image which corresponds to the Voronoi diagram.
     */
    static boolean labelVoronoiOctagon(ClearCLBuffer label_map, ClearCLBuffer label_voronoi_destination) {
     ...
     */
    static boolean touchMatrixToAdjacencyMatrix(ClearCLBuffer touch_matrix, ClearCLBuffer adjacency_matrix) {
     ...
     * 
     */
    static boolean adjacencyMatrixToTouchMatrix(ClearCLBuffer adjacency_matrix, ClearCLBuffer touch_matrix) {
     ...
     */
    static boolean pointlistToLabelledSpots(ClearCLBuffer pointlist, ClearCLBuffer spots_destination) {
     ...
     * This method is executed on the CPU and not on the GPU/OpenCL device.
     */
    static ResultsTable statisticsOfImage(ClearCLBuffer arg1, ResultsTable arg2) {
     ...
     */
    static boolean nClosestDistances(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3) {
     ...
     */
    static boolean excludeLabels(ClearCLBuffer binary_flaglist, ClearCLBuffer label_map_input, ClearCLBuffer label_map_destination) {
     ...
     */
    static boolean averageDistanceOfNFarOffPoints(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * 
     */
    static boolean standardDeviationOfTouchingNeighbors(ClearCLBuffer values, ClearCLBuffer touch_matrix, ClearCLBuffer standard_deviation_values_destination) {
     ...
     */
    static boolean neighborsOfNeighbors(ClearCLBuffer touch_matrix, ClearCLBuffer neighbor_matrix_destination) {
     ...
     * 
     */
    static boolean generateParametricImage(ClearCLImageInterface label_map, ClearCLImageInterface parameter_value_vector, ClearCLImageInterface parametric_image_destination) {
     ...
     * 
     */
    static boolean generateParametricImageFromResultsTableColumn(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ResultsTable arg3, String arg4) {
     ...
     */
    static boolean excludeLabelsWithValuesOutOfRange(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4, double arg5) {
     ...
     * Hand over a vector of values and a range specifying which labels with which values are eliminated.
     */
    static boolean excludeLabelsWithValuesWithinRange(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4, double arg5) {
     ...
     */
    static boolean combineVertically(ClearCLImageInterface stack1, ClearCLImageInterface stack2, ClearCLImageInterface destination) {
     ...
     */
    static boolean combineHorizontally(ClearCLImageInterface stack1, ClearCLImageInterface stack2, ClearCLImageInterface destination) {
     ...
     */
    static boolean reduceStack(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4) {
     ...
     * lower intensity, and to 0 otherwise.
     */
    static boolean detectMinima2DBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     * higher intensity, and to 0 otherwise.
     */
    static boolean detectMaxima2DBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     * lower intensity, and to 0 otherwise.
     */
    static boolean detectMinima3DBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     * higher intensity, and to 0 otherwise.
     */
    static boolean detectMaxima3DBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean depthColorProjection(ClearCLImageInterface arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4, double arg5) {
     ...
     */
    static boolean generateBinaryOverlapMatrix(ClearCLBuffer label_map1, ClearCLBuffer label_map2, ClearCLBuffer touch_matrix_destination) {
     ...
     */
    static boolean nonLocalMeans(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     */
    static boolean undefinedToZero(ClearCLBuffer source, ClearCLBuffer destination) {
     ...
     */
    static boolean generateJaccardIndexMatrix(ClearCLBuffer label_map1, ClearCLBuffer label_map2, ClearCLBuffer jaccard_index_matrix_destination) {
     ...
     * Major parts of this operation run on the CPU.
     */
    static boolean generateTouchCountMatrix(ClearCLBuffer label_map, ClearCLBuffer touch_count_matrix_destination) {
     ...
     */
    static boolean minimumXProjection(ClearCLImageInterface source, ClearCLImageInterface destination_min) {
     ...
     * Determines the minimum intensity projection of an image along Y.
     */
    static boolean minimumYProjection(ClearCLImageInterface source, ClearCLImageInterface destination_min) {
     ...
     */
    static boolean meanXProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean meanYProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean squaredDifference(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean absoluteDifference(ClearCLBuffer source1, ClearCLBuffer source2, ClearCLBuffer destination) {
     ...
     */
    static boolean replacePixelsIfZero(ClearCLImageInterface input1, ClearCLImageInterface input2, ClearCLImageInterface destination) {
     ...
     */
    static boolean voronoiLabeling(ClearCLBuffer input, ClearCLImageInterface destination) {
     ...
     * The resulting label map is written to the output.
     */
    static boolean extendLabelingViaVoronoi(ClearCLBuffer input, ClearCLImageInterface destination) {
     ...
     * 
     */
    static boolean findMaxima(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * 
     */
    static boolean mergeTouchingLabelsSpecial(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, ClearCLBuffer arg4) {
     ...
     * 
     */
    static boolean mergeTouchingLabels(ClearCLBuffer source, ClearCLBuffer destination) {
     ...
     */
    static boolean averageNeighborDistanceMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean cylinderTransform(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     */
    static boolean detectAndLabelMaxima(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, boolean arg6) {
     ...
     */
    static boolean drawDistanceMeshBetweenTouchingLabels(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean drawMeshBetweenTouchingLabels(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean excludeLabelsOutsideSizeRange(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     */
    static boolean extendLabelsWithMaximumRadius(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean findAndLabelMaxima(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, boolean arg4) {
     ...
     */
    static boolean makeIsotropic(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     * 
     */
    static boolean touchingNeighborCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean rigidTransform(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7, double arg8) {
     ...
     */
    static boolean sphereTransform(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6, double arg7) {
     ...
     */
    static boolean subtractGaussianBackground(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean thresholdDoG(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, boolean arg6) {
     ...
     */
    static boolean driftCorrectionByCenterOfMassFixation(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean driftCorrectionByCentroidFixation(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5, double arg6) {
     ...
     */
    static boolean intensityCorrection(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean intensityCorrectionAboveThresholdOtsu(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean labelMeanIntensityMap(ClearCLBuffer input, ClearCLBuffer label_map, ClearCLBuffer destination) {
     ...
     */
    static boolean labelStandardDeviationIntensityMap(ClearCLBuffer input, ClearCLBuffer label_map, ClearCLBuffer destination) {
     ...
     */
    static boolean labelPixelCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean parametricWatershed(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean meanZProjectionAboveThreshold(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * It writes the resulting  coordinates in a pointlist image. Depending on the dimensionality d of the labelmap and the number  of labels n, the pointlist image will have n*d pixels.
     */
    static boolean centroidsOfBackgroundAndLabels(ClearCLBuffer source, ClearCLBuffer pointlist_destination) {
     ...
     */
    static boolean seededWatershed(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3, double arg4) {
     ...
     */
    static boolean averageDistanceOfNClosestNeighborsMap(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean drawTouchCountMeshBetweenTouchingLabels(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean localMaximumAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean localMaximumAverageNeighborDistanceMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean localMaximumTouchingNeighborCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean localMeanAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean localMeanAverageNeighborDistanceMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean localMeanTouchingNeighborCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean localMeanTouchPortionMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean localMedianAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean localMedianAverageNeighborDistanceMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean localMedianTouchingNeighborCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean localMinimumAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean localMinimumAverageNeighborDistanceMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean localMinimumTouchingNeighborCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean localStandardDeviationAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean localStandardDeviationAverageNeighborDistanceMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean localStandardDeviationTouchingNeighborCountMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean labelMinimumIntensityMap(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3) {
     ...
     * 
     */
    static boolean labelMaximumIntensityMap(ClearCLBuffer arg1, ClearCLBuffer arg2, ClearCLBuffer arg3) {
     ...
     * 
     */
    static boolean labelMaximumExtensionRatioMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * 
     */
    static boolean labelMaximumExtensionMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     * Major parts of this operation run on the CPU.
     */
    static boolean generateIntegerGreyValueCooccurrenceCountMatrixHalfBox(ClearCLBuffer integer_image, ClearCLBuffer grey_value_cooccurrence_matrix_destination) {
     ...
     * Major parts of this operation run on the CPU.
     */
    static boolean generateIntegerGreyValueCooccurrenceCountMatrixHalfDiamond(ClearCLBuffer integer_image, ClearCLBuffer grey_value_cooccurrence_matrix_destination) {
     ...
     */
    static double getMeanOfMaskedPixels(ClearCLBuffer arg1, ClearCLBuffer arg2) {
     ...
     */
    static boolean divideByGaussianBackground(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean generateGreyValueCooccurrenceMatrixBox(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     */
    static boolean greyLevelAtttributeFiltering(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4) {
     ...
     */
    static boolean binaryFillHolesSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean binaryWekaPixelClassifier(ClearCLBuffer input, ClearCLBuffer destination, String features, String modelfilename) {
     ...
     */
    static boolean wekaLabelClassifier(ClearCLBuffer input, ClearCLBuffer label_map, ClearCLBuffer destination, String features, String modelfilename) {
     ...
     */
    static boolean generateLabelFeatureImage(ClearCLBuffer input, ClearCLBuffer label_map, ClearCLBuffer label_feature_image_destination, String feature_definitions) {
     ...
     * Example: "MEAN_INTENSITY count_touching_neighbors"
     */
    static ClearCLBuffer generateLabelFeatureImage(ClearCLBuffer arg1, ClearCLBuffer arg2, String arg3) {
     ...
     */
    static boolean labelSurface(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3, double arg4, double arg5) {
     ...
     */
    static boolean reduceLabelsToLabelledSpots(ClearCLBuffer input_labels, ClearCLBuffer destination_labels) {
     ...
     * 
     */
    static boolean labelMeanExtensionMap(ClearCLBuffer input, ClearCLBuffer destination) {
     ...
     */
    static boolean meanZProjectionBelowThreshold(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     */
    static boolean euclideanDistanceFromLabelCentroidMap(ClearCLBuffer labelmap_input, ClearCLBuffer destination) {
     ...
     */
    static boolean gammaCorrection(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     */
    static boolean zPositionOfMaximumZProjection(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean zPositionProjection(ClearCLImageInterface source_stack, ClearCLImageInterface z_position, ClearCLImageInterface destination) {
     ...
     */
    static boolean zPositionRangeProjection(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3, int arg4, int arg5) {
     ...
     */
    static boolean varianceSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width, half-height and half-depth (radius). If 2D images are given, radius_z will be ignored. 
     */
    static boolean standardDeviationSphere(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width, half-height and half-depth (radius). If 2D images are given, radius_z will be ignored. 
     */
    static boolean varianceBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * its half-width, half-height and half-depth (radius). If 2D images are given, radius_z will be ignored. 
     */
    static boolean standardDeviationBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * Convolve the image with the Tenengrad kernel slice by slice.
     */
    static boolean tenengradSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean sobelSliceBySlice(ClearCLImageInterface source, ClearCLImageInterface destination) {
     ...
     */
    static boolean extendedDepthOfFocusVarianceProjection(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * The sigma parameter allows controlling an Gaussian blur which should smooth the altitude map.
     */
    static boolean extendedDepthOfFocusTenengradProjection(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3) {
     ...
     * The sigma parameter allows controlling an Gaussian blur which should smooth the altitude map.
     */
    static boolean extendedDepthOfFocusVarianceProjection(ClearCLImageInterface arg1, ClearCLImageInterface arg2, double arg3, double arg4, double arg5) {
     ...
     * The end points of the lines correspond to the centroids of the labels. 
     */
    static boolean drawMeshBetweenNClosestLabels(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
     ...
     * The end points of the lines correspond to the centroids of the labels.
     */
    static boolean drawMeshBetweenProximalLabels(ClearCLBuffer arg1, ClearCLBuffer arg2, double arg3) {
